  ...
  try {
    ...
    const seedApps = [
      ...
      },
      {
        ...
        plans: [
          { key: 'hobbyist', name: 'Hobbyist', price: 24, yearlyPrice: 240, features: ['300 Images/Day', 'AI Vehicle Detection', '12 Colour Categories', 'ZIP Export', 'Quick Reassign', 'Email Support'], color: '#06b6d4', whiteLabel: false, customDomain: false },
          { key: 'pro', name: 'Pro', price: 99, yearlyPrice: 990, features: ['2,000 Images/Day', 'Everything in Hobbyist', 'Watermark Editor', 'Priority AI Processing', 'Batch Folders & ZIPs'], popular: true, color: '#f59e0b', whiteLabel: false, customDomain: false },
          { key: 'unlimited', name: 'Unlimited', price: 249, yearlyPrice: 2490, features: ['10,000 Images/Day', 'Everything in Pro', 'Commercial Use License', 'Dedicated Support', 'Multi-Machine (2 PCs)'], color: '#a855f7', whiteLabel: false, customDomain: false }
        ],
      ...
      },
      {
        ...
        techStack: ['React 19', 'TypeScript', 'Express', 'MongoDB', 'JWT Auth', 'Square Payments', 'Vite', 'TailwindCSS'],
        plans: [
